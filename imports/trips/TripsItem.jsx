		...
		return (
			<div>
				<div id="border">
					...
					<button
						id="mainBtns"
						className="mini ui button ui inverted orange button"
					...
					<button
						id="mainBtns"
						className="mini ui button ui inverted button"
						onClick={this.redirect.bind(this)}
					>
						more &nbsp;<i class="add square icon" />
					</button>
					<div>
						<form
							style={styles}
						...
						>
							...
							<input
								ref="amount"
								placeholder="new Initial budget"
							/>
							<div className="ui inverted divider" />
							<button
								id="total"
								className="tiny ui button ui inverted green button"
							>
								update
							</button>
						</form>
